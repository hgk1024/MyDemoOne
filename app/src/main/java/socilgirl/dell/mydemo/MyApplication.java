...
//        headers.put("User-Agent", SystemInfoUtils.getUserAgent(this, AppContant.APPID));
//        //全局设置请求参数
//        HttpParams params = new HttpParams();
//        params.put("appId", AppContant.APPID);
//
//        //以下设置的所有参数是全局参数,同样的参数可以在请求的时候再设置一遍,那么对于该请求来讲,请求中的参数会覆盖全局参数
//        EasyHttp.getInstance()
//
//                //可以全局统一设置全局URL
//                .setBaseUrl(AppContant.BASEURL)//设置全局URL
//
...
//                //全局设置自定义缓存大小，默认50M
//                .setCacheMaxSize(50 * 1024 * 1024)//设置缓存大小为100M
