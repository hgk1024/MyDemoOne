...
public class DialogStyle extends Dialog{
    ...
    private LinearLayout btnLayout;//按钮显示及文本
    ...
    public DialogStyle(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_style_layout);
        //按空白处不能取消动画
    ...
    private void initView() {
        ...
        btnLayout = findViewById(R.id.layout_btn);
    }
